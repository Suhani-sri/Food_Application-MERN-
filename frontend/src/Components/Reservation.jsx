    ...
    <section className='reservation' id='reservation'>
        <div className='container'>
            <div className='banner'>
                <img src='/reservation.png' alt='res'></img>
            </div>
        <div className='banner'>
            <div className='reservation_form_box'>
                ...
                <form>
                    <div>
                        <input type='text' placeholder='First Name' vlue={firstName} onChange={(e) => setFirstName(e.target.value)}></input>
                        <input type='text' placeholder='Last Name' vlue={lastName} onChange={(e) => setLastName(e.target.value)}></input>
                    </div>
                    <div>
